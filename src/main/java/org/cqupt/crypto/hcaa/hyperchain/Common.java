...
public class Common {
    ...
    public static final String tlsca = "hyperchain/certs/tls/tlsca.ca";
    public static final String tls_peer_cert = "hyperchain/certs/tls/tls_peer.cert";
    public static final String tls_peer_priv = "hyperchain/certs/tls/tls_peer.priv";
    public static final String sdkcert_cert = "hyperchain/certs/sdkcert.cert";
    public static final String sdkcert_priv = "hyperchain/certs/sdkcert.priv";
    public static final String unique_pub = "hyperchain/certs/unique.pub";
    public static final String unique_priv = "hyperchain/certs/unique.priv";
    ...
    public static final String bin = "hyperchain/solidity/sol2/TestContract_sol_TypeTestContract.bin";
    public static final String abi = "hyperchain/solidity/sol2/TestContract_sol_TypeTestContract.abi";
